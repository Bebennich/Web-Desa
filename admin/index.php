...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style="background-color: #f67280 !important;">
            <a class="navbar-brand" href="index.html">Trans</a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color:#355c7d  !important;">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="index.php?halaman=ubahseat">
                                <div class="sb-nav-link-icon"><i class="fas fa-money-check"></i></div>
                                Seat
                            </a>
                </nav>
                    ...
                    <div class="container-fluid">
                        <?php 
                            if (isset($_GET['halaman'])) {
                                ...
                                }elseif ($_GET['halaman']=="ubahseat") {
                                    include 'ubahseat.php';
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">&copy; Eka Bagus Priambudi 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
